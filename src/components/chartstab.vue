                    ...
                    <div class="chartstab-item">
                        <div class="chartstab-list" v-for="(item,index) in item.content" :key="index">
                            <div class="chartstab-img">
                                <img src="https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fsafe-img.xhscdn.com%2Fbw1%2F5d88a972-1b34-43ed-8b3a-4a7ebbb900a1%3FimageView2%2F2%2Fw%2F1080%2Fformat%2Fjpg&refer=http%3A%2F%2Fsafe-img.xhscdn.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1708410432&t=f8597f672e008b63a5fd8f0ed915d8e0" alt="">
                            </div>
...
const chartstab = ref([
    {title:'全部', content:[
  { name: '剑来', img_url: '2.png', describe: '一剑破万法，剑道通神明。', num: '影视连载1032万字' },
  { name: '择天记', img_url: '3.png', describe: '命途多舛，弃天命择其爱。', num: '影视连载987万字' },
  { name: '全职高手', img_url: '4.png', describe: '电竞之巅，谁与争锋。', num: '影视连载920万字' },
  { name: '斗破苍穹', img_url: '5.png', describe: '穷奇苦零，唯我独尊。', num: '影视连载889万字' },
  { name: '天珠变', img_url: '6.png', describe: '珠光宝气，天下变色。', num: '影视连载842万字' },
  { name: '庆余年', img_url: '7.png', describe: '红颜多薄命，谁能长相守。', num: '影视连载789万字' },
  { name: '将夜', img_url: '8.png', describe: '夜幕降临，黑暗来袭。', num: '影视连载754万字' },
  { name: '择天记', img_url: '9.png', describe: '逆天改命，逐梦前行。', num: '影视连载701万字' },
  ]},
